...
public class ProfileModifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFNameView.setText(user.getFirstName());
        mLNameView.setText(user.getLastName());
        ...
        if (user.getProfilPicture() != null && user.getProfilPicture().getBitmap() != null)
            profilImage.setImageBitmap(user.getProfilPicture().getBitmap());
